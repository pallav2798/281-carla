...
from .views import CurrentTripView, EndTripView, SellerCarTrips, TripDetailView, TripHistoryView
...
urlpatterns = [
    ...
    path('trip-detail/<int:pk>',TripDetailView.as_view(),name="trip-detail")
]